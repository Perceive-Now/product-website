        ...
        <div key={index}>
          {parts.map((part, idx) => {
            if (idx % 2 === 0) {
              ...
              const key = part.trim();
              // Set default value from formData or keep the original value
              const defaultValue = formData[key] || key; // Use key as default value
    ...
    <>
      ...
      {/* <Modal open={modalOpen} handleOnClose={handleModalClose}>
        ...
        <div className="bg-foundationOrange-100 p-4 border border-secondary-500 mx-auto rounded-lg">
          ...
          <div className=" text-secondary-800 text-justify relative bottom-0 duration-500 delay-500 stream-answer text-align">
