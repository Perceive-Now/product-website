...
interface LiquidSphereLoaderProps extends SVGProps<SVGSVGElement> {
  percentage: number; // Height of the liquid, from 0 to 100
}
      ...
      <g id="sphere">
        <g clipPath="url(#clip0_1_46)">
          ...
          <motion.g
            ...
            initial={{ y: yPosition, x: 0 }}
            animate={{
              y: yPosition,
            }}
          >
            <motion.path
              d="M361 21.6892C353.357 23.7396 345.509 26.6155 337.3 30.242C323.563 36.3097 309.827 42.3775 296.09 43.7447C283.487 44.999 269.124 38.9172 252.179 31.7423C230.806 22.6923 205.326 11.9031 174.09 11.9031C151.783 11.9031 132.65 19.2401 114.225 26.3055C86.3953 36.9773 60.1818 47.0293 27.0902 30.242C-27.9098 2.34055 -62.4098 3.11105 -107.91 33.6247C-153.41 64.1384 -190.485 58.4388 -220.749 44.553C-223.681 43.2081 -226.582 41.7986 -229.463 40.3993C-240.95 34.8194 -252.106 29.3999 -263.499 28.8712C-279.468 28.0243 -295.437 35.719 -311.406 43.4137C-323.938 49.4518 -336.469 55.4899 -349 57.4006C-364.849 59.8172 -380.697 55.573 -396.546 51.3288C-409.197 47.9409 -421.849 44.553 -434.5 44.553C-447.665 44.553 -460.83 48.2216 -473.995 51.8903C-489.33 56.1637 -504.665 60.437 -520 58.9121C-533.736 57.5462 -547.473 51.4839 -561.209 45.4215C-575.973 38.906 -590.736 32.3904 -605.5 31.7053C-627.3 30.5491 -646.122 36.8739 -664.899 43.1833C-687.988 50.9417 -711.007 58.6769 -739.409 52.4504C-754.759 49.0855 -769.434 43.6476 -783.913 38.2821C-818.454 25.4829 -851.883 13.0955 -890.7 30.242C-904.437 36.3097 -918.173 42.3775 -931.91 43.7447C-947.245 45.271 -962.58 40.9937 -977.915 36.7165C-1005.51 29.021 -1027.71 28.7431 -1055.36 36.1545C-1071.21 40.4025 -1087.06 44.6505 -1102.91 42.2318C-1115.44 40.3194 -1127.97 34.2759 -1140.5 28.2324C-1174.94 11.6237 -1197.41 11.5685 -1231.16 29.3726C-1234.27 31.012 -1237.49 32.8449 -1240.79 34.716C-1252.6 41.4245 -1265.27 48.6226 -1276.41 49.1401C-1360.99 49.1401 -1360.96 51.7094 -1359.76 174.411C-1359.59 190.986 -1359.41 209.752 -1359.41 231L361 231V21.6892Z"
              fill="#5C1FC4"
              initial={{ y: 160, x: 50 }}
              animate={{
                x: [1000, -200, 1000], // Horizontal motion from 0 to -20 and back to 0
              }}
              transition={{
                duration: 30,
                ease: "easeInOut",
          ...
          >
            <motion.path
              ...
              initial={{ y: 160, x: 50 }}
              animate={{
                x: [50, -1500, 50], // Horizontal motion from 0 to -20 and back to 0
              }}
              transition={{
                duration: 40,
                ease: "easeInOut",
          ...
          >
            <motion.path
              ...
              initial={{ y: 160, x: 50 }}
              animate={{
                x: [50, -1200, 50], // Horizontal motion from 0 to -20 and back to 0
              }}
              transition={{
                duration: 25,
                ease: "easeInOut",
