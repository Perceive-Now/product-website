  ...
  return (
    <div className="border-gray-200 shadow-custom border px-2 pt-2 pb-4 w-full space-y-2">
      <DataSection
        ...
        error={error}
        title={
          <PageTitle titleClass="font-bold" title="16. Trends in PCT Applications Over Time" />
        }
      >
        <div>
          {/* {data && ( */}
          ...
          <div className="space-y-2 text-secondary-800 mt-4">
            ...
            <div>
              ...
              <ul className="list-disc ml-3 text-sm mt-1 font-medium">
                <li>
                  Annual Growth in PCT Applications: "PCT applications have witnessed an annual
                  growth rate of X% over the last Y years, indicating an increasing preference for
                  international patent protection."
                </li>
                <li>
                  Year with Highest Number of PCT Applications: "The year Z saw a record number of
                  PCT applications, totaling X, highlighting a peak year for global patent filing
                  activities."
                </li>
                <li>
                  Decade Comparison of PCT Filings: "Comparing the last two decades, there has been
                  an increase of X% in PCT filings, showcasing a growing trend towards
                  internationalizing patent protection."
                </li>
                <li>
                ...
                <li>
                  Impact of Global Events on PCT Applications: "Following the event A in year B,
                  there was a noticeable increase/decrease in PCT applications by X%, reflecting the
                  global impact on patent filing strategies."
                </li>
              </ul>
            </div>
          </div>
