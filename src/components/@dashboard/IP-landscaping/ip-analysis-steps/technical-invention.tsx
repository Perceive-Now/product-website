    ...
    <>
      <div className="space-y-2.5">
        ...
        <h4 className="text-gray-600 text-xl font-semibold">
          In which technical field does the invention fall?
        </h4>
        <p className="text-gray-600 text-sm">
          E.g. SkinCheck is at the cutting-edge intersection of Computer Vision, Artificial
          Intelligence, and Machine Learning. It's specifically designed for skin cancer detection,
          leveraging advanced AI techniques like CycleGANs for domain adaptation. This integration
          of machine learning with computer vision sets SkinCheck apart in the healthcare technology
          sector, offering a novel approach to diagnosing skin cancer.
        </p>
        <Button
          type="secondary"
          size="small"
