...
const handleJoyrideCallback = (data: any) => {
  ...
  return (
    <>
      <div className="flex mt-1 mr-[40px]">
        {/* Violet Sidebar */}
        <Joyride
          ref={joyrideRef}
          steps={steps}
          ...
          <div>
            ...
            <div className="mt-2">
              {sidebarItems.map((item) => (
                <button
                  key={item.key}
                  className={classNames(`${item.classname} py-2 px-4 w-full text-center`, {
        ...
        {open && activeItem && (
          <div className="z-10 bg-red  fixed left-[66px]  h-[calc(100vh-80px)] w-64 flex flex-col p-2 shadow-lg">
