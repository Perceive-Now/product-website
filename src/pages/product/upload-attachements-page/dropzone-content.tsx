    ...
    <>
      <div className="flex flex-row justify-center lg:gap-x-5 gap-x-2 mb-5 lg:mb-9 mt-6 lg:mt-15">
        <div className="flex flex-col items-center text-lg font-bold">
          <UploadIcon />
          <p className="text-center text-base">Drag and Drop files to upload</p>
          <p className="text-base py-0.5">or</p>
          <p className="text-primary-900 underline cursor-pointer hover:text-primary-800 transition duration-300 ease-in-out text-sm">
            Browse
          </p>
        </div>
        <div>
          <p className="text-base font-bold">Supported file types (up to 40mb)</p>
