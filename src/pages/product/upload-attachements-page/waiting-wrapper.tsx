...
export default function WaitingWrapper({
  ...
  return (
    <div className="flex flex-row justify-between lg:gap-[100px] 2xl:gap-x-[150px]">
      <div className="flex flex-col w-full min-h-[400px] bg-white rounded-lg p-2 shadow-page-content">
