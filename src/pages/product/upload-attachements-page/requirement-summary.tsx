...
export default function RequirementSummary({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex flex-row justify-between gap-x-[50px]">
      <div className="flex xl:grid xl:grid-cols-2 flex-col lg:min-w-[400px] xl:max-w-[800px] 2xl:max-w-[900px] w-full h-[calc(100vh-188px)] pn_scroller overflow-y-auto bg-white rounded-lg p-2 shadow-page-content">
        <div className={classNames("flex flex-col", { "col-span-2": requirementPercentage > 95 })}>
          {transformedRequirementSummary.length > 0 && (
            <>
              <p className="font-bold text-2xl text-secondary-900">Here's a sneak peek!</p>
