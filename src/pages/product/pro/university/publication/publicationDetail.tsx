...
//
export default function CompanyPublication() {
    ...
    <div>
      ...
      <Tab.Group>
        ...
        <Tab.Panels>
          <Tab.Panel>
            <div>
              <p className="text-[22px] text-primary-900 font-semibold">List of publications</p>
              <TooltipProvider>
                <div className="my-4">
          ...
          <Tab.Panel>
            <div>
              <p className="text-[22px] text-primary-900 font-semibold">List of authors</p>
