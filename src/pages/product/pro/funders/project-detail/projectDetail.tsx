...
export default function FunderProjectDetail() {
  const { id } = useParams();
    ...
    <ReportSaveButtons />
      ...
      <div className="mt-5 grid grid-cols-12 gap-x-5">
        <div className="col-span-9">
          <div className="text-appGray-900 font-bold text-xl mb-2">Abstract</div>
        ...
        <div className="col-span-3">
          ...
          <div className="grid grid-cols-3">
            ...
            <div className="font-bold text-appGray-900 col-span-2 mb-2">Lead Investigator:</div>

            <div className="col-span-1 text-appGray-900">-</div>
            <div className="font-bold text-appGray-900 col-span-2 mb-2">Award amount:</div>
...
const breadcrumbs = [
  { title: "Funders", link: "/funders" },
  { title: "Project Details", link: "/patents/1" },
];
