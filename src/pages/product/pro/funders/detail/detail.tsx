...
export default function FunderDetail() {
  ...
  return (
    <div>
      ...
      <div className="text-2xl leading-8 text-primary-900 font-semibold mt-4">
        {companyName ? <span>{companyName}</span> : <span>Microsoft Corporation</span>}
      </div>
      <p className="text-secondary-800">Washington DC</p>
      ...
      <Tab.Group>
        ...
        <Tab.Panels>
          <Tab.Panel>
            <div>
              <p className="text-[22px] text-primary-900 font-semibold">List of projects</p>
              <TooltipProvider>
                <div className="my-4">
